import type { Card, Command, GameEvent, GameState, StandardCard } from '../game/types';
export interface Snapshot<C extends Card = StandardCard> {
...
export interface GameSession<C extends Card = StandardCard> {
